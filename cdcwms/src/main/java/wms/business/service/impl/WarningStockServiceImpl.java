...
@Service("WarningStockService")
public class WarningStockServiceImpl extends BaseServiceImpl<WarningStock>
		implements WarningStockService {

	@SuppressWarnings("unchecked")
	@Override
	public PageData<Map<String, Object>> queryWarningStock(int page, int rows, String listsql, String countsql,
