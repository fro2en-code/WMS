...
public class LesSendJobDServiceImpl extends BaseServiceImpl<WmsLesBill> implements LesJobService {
	...
	public void execute() {
		try {
			...
			NameValuePair[] nameValuePairs = { new NameValuePair("j_username", "3PL0103"),
					new NameValuePair("j_password", "ZSgj1234") };
