...
public class LesSendJobCServiceImpl extends BaseServiceImpl<WmsLesBill> implements LesJobService {
	...
	public void execute() {
		try {
			...
			NameValuePair[] nameValuePairs = { new NameValuePair("j_username", "3PL0105"),
					new NameValuePair("j_password", "ZSgj4321") };
