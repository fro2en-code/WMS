...
/**
 * AES 工具类 Author Hmgx data 2016-10-12 by 融通智联
 */
public class AES {
    ...
    // 加密
    public static String Encryption(String content, String pass) {
    ...
    // 解密
    public static String Decryption(String ciphertext, String pass) {
        logger.warn("ciphertext=" + ciphertext);
        logger.warn("pass=" + pass);
        if (ciphertext.equals("") || pass.equals("")) {
            return "";
        }
        ...
        try {
            ...
            logger.debug("decryptResult={}", str);
            return str;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return e.getMessage();
