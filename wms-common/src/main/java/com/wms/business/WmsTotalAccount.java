 ...
 *
 */
public class WmsTotalAccount extends BaseModel {
    ...
    public String toString() {
        return "WmsTotalAccount [gcode=" + gcode + ", gname=" + gname + ", gtype=" + gtype + ", oraCode=" + oraCode
                + ", oraName=" + oraName + ", totalNum=" + totalNum + ", whCode=" + whCode + ", whName=" + whName + "]";
    }
